...
import { Shield, Home, UtensilsCrossed, FileCheck, Star, GraduationCap } from "lucide-react";
...
const TABS = [
  ...
  {
    id: "social", icon: FileCheck, label: "Соцпакет",
    content: [
      "Официальное трудоустройство по ТК РФ",
      "Оплачиваемый отпуск — не менее 28 дней",
      "Медицинская страховка и доступ к медпомощи",
      "Компенсация проезда к месту работы и обратно",
      "Доплаты за особо сложные задачи",
    ]
  },
  {
