...
const STAGES = [
  ...
  },
  {
    ...
    items: [
      ...
      "Адрес: г. Хабаровск, ул. Карла Маркса, д. 66",
      "Билеты до Хабаровска оплачиваются работодателем",
    ],
  },
  {
    num: "5",
  ...
  },
  {
    ...
    duration: "1–2 дня",
    items: [
      "Единовременная выплата 500 000 рублей в первый рабочий день",
      "Организация билетов и трансфера в аэропорт",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-20">
        ...
        <div>
          ...
          <div className="mt-6 bg-primary/5 border border-primary/20 rounded-xl p-4 text-center font-inter text-sm text-foreground">
            <span className="font-bold">Общий срок:</span> 3–4 недели с момента подачи заявки до выезда на место работы.
          </div>
        </div>
