...
const TESTIMONIALS = [
  {
    name: "Алексей М.",
    role: "Строитель, Омск",
    text: "Поехал с опаской, но всё оказалось именно так, как описывали. Получил 625 000 ₽ подъёмных при подписании договора, жильё нормальное, кормят хорошо. Зарплата 355 000 в месяц — за год заработал больше, чем за три года дома. Уже оформил земельный участок в ЛНР.",
    stars: 5,
  ...
  },
  {
    ...
    text: "Работаю на технике, возим стройматериалы. Платят вовремя, дважды в месяц как обещали — получаю около 350 000 в месяц плюс надбавки за безаварийную работу. Охрана хорошая — ни разу не чувствовал угрозы. Рекомендую тем, кто не боится работать.",
    stars: 5,
