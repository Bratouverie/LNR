      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground font-inter mt-4 max-w-xl mx-auto">
            Работа осуществляется на освобождённых территориях ЛНР и ДНР под защитой и обеспечением безопасности специальных подразделений Вооружённых Сил Российской Федерации. Каждый специалист обеспечен медицинской, психологической и правовой поддержкой.
          </p>
        </div>
