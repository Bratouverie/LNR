...
const DOCS = [
  ...
  },
  {
    ...
    date: "01.03.2022",
    desc: "«О мерах по поддержке граждан, принимающих участие в программах государственного восстановления»",
  ...
  },
  {
    ...
    date: "05.05.2023",
    desc: "«О мерах по поддержке семей лиц, принимающих участие в программах государственного восстановления»",
...
const SUPPORT = [
  ...
  { label: "Координация с министерствами РФ", items: ["Министерство развития Дальнего Востока и Арктики", "Министерство строительства и ЖКХ", "Министерство внутренних дел РФ", "Федеральная служба безопасности РФ (ФСБ)"] },
];
