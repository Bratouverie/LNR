      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-10">
        ...
        <div className="grid sm:grid-cols-2 gap-5">
          {[
            ...
            { icon: TrendingUp, title: "Условия участия", text: "Официальный трудовой договор, зарплата от 300 000 ₽/мес, подъёмные 2 500 000 ₽, жильё и питание бесплатно." },
