...
Deno.serve(async (req) => {
  try {
    ...
    const anketaData = {
      ...
      childrenCount: form.childrenCount !== undefined && form.childrenCount !== '' ? Number(form.childrenCount) : null,
      emergencyContactName: form.emergencyContactName || null,
      emergencyContactPhone: form.emergencyContactPhone || null,
      emergencyContactRelation: form.emergencyContactRelation || null,
      militaryRank: form.militaryRank || null,
      militarySpecialty: form.militarySpecialty || null,
      militaryUnit: form.militaryUnit || null,
      convictionDetails: form.convictionDetails || null,
      expectedSalary: form.expectedSalary !== undefined && form.expectedSalary !== '' ? Number(form.expectedSalary) : null,
      motivation: form.motivation || null,
      readyDocuments: form.readyDocuments || {},
      readyToStartDate: form.readyToStartDate || null,
      ...
      innUrl: files.innUrl || null,
      militaryIdUrl: files.militaryIdUrl || null,
      driverLicenseUrl: files.driverLicenseUrl || null,
      workBookUrl: files.workBookUrl || null,
      certificatesUrl: files.certificatesUrl || null,
