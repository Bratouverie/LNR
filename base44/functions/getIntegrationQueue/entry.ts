...
// ═══════════════════════════════════════════════════════════════
// getIntegrationQueue — Lists integration queue entries (super_admin only)
//
...
Deno.serve(async (req) => {
  try {
    ...
    const queue = await base44.asServiceRole.entities.IntegrationQueue.filter(filter, '-created_date', 100);
